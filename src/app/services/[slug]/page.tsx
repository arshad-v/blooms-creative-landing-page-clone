...
const servicesData = {
  ...
  "ai-automation": {
    ...
    description: "Harness the power of AI to automate repetitive tasks and unlock new efficiencies. We implement intelligent automation solutions that save time, reduce costs, and improve accuracy.",
    features: [
